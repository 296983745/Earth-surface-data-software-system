<template>
    <div class="page-container">
        <div class="header-container">
            <img style="width: 50px;margin-right: 20px;" src="../../image/evaluate.png" alt="Evaluation" />
            <h4 class="title">执行一次新的评估</h4>
        </div>
        <div class="body-container">
            <el-form ref="form" :model="sizeForm" :rules="rules" label-width="150px" size="medium ">
                <h4 style="width:800px;margin-bottom: 20px; text-align: left;">1.选择FAIR成熟度指标的集合（又称FAIR指标测试）来验证你的资源。
                </h4>
                <el-select v-model="sizeForm.indicators" placeholder="Please select evaluation indicator set"
                    style="margin-bottom: 20px; display: flex;">
                    <el-option label="FAIR Enough metadata maturity indicators"
                        value="FAIR Enough metadata maturity indicators"></el-option>
                    <el-option label="FAIR Evaluator maturity indicators"
                        value="aturity indicators in ruby to evaluate a dataset FAIRness"></el-option>
                    <el-option label="FAIR Enough data maturity" value="FAIR Enough data maturity"></el-option>
                    <el-option label="FAIR Enough data maturity indicators"
                        value="FAIR Enough data maturity indicators"></el-option>
                    <el-option label="FAIR maturity indicators for Rare Disease"
                        value="FAIR maturity indicators for Rare Disease"></el-option>
                </el-select>
                <!-- <el-input type="textarea" :rows="3" placeholder="" v-model="sizeForm.indicators" readonly
                    style="margin-bottom: 20px; display: flex;">
                </el-input> -->
                <h4 style="margin-bottom: 20px; text-align: left;">2. 提供你要评估的资源或数字对象的URL。<el-tooltip class="item"
                ...
                <el-input v-model="sizeForm.url" placeholder="Please input evaluation url" style="margin-bottom: 20px;" />
        ...
        <div class="header-container">
            <img style="width: 50px;margin-right: 20px;" src="../../image/result.png" alt="Evaluation" />
            <h4 class="title">最近的评估记录</h4>
        </div>
